...
public class Task2 {
	public static void main(String[] args) {
		...
		System.out.println("Время, затраченное на получение 100000 рандомных элементов с arrayList(в милисекундах): "
				+ (finish - start));

		long start2 = System.currentTimeMillis();
		getElement(linkedList);
		long finish2 = System.currentTimeMillis();
		System.out.println("Время, затраченное на получение 100000 рандомных элементов с linkedList(в милисекундах): "
				+ (finish2 - start2));
